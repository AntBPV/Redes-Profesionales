...
urlpatterns = [
    ...
    path('list', EnterpriseProfileApiView.as_view(), name='enterprise-profile-list'),
    # List/pk will be used for getting a single object, deleting and updating it
    path('list/<int:pk>', EnterpriseProfileApiView.as_view(), name='enterprise-profile-detail'),
]